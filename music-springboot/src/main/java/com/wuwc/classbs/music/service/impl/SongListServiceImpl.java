...
import com.wuwc.classbs.music.dao.SongListMapper;
import com.wuwc.classbs.music.domain.SongList;
import com.wuwc.classbs.music.service.SongListService;
...
public class SongListServiceImpl implements SongListService {
    ...
    public List<SongList> GetSongListId(List id) {
        return songListMapper.GetSongListId(id);
    }
    public List<SongList> StyleOfSongId(String style,Integer num) {
        return songListMapper.StyleOfSongId(style,num);
    }
}