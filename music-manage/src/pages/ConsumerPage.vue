<template>
    <div class="table">
        ...
        <el-table size="mini" ref="multipleTable" border style="width:100%" height="680px" :data="data" @selection-change="handleSelectionChange">
            ...
            <el-table-column label="用户图片" width="100" align="center">
            ...
            <el-table-column prop="location" label="地区" width="80" align="center"></el-table-column>            
             <el-table-column label="评价管理" width="100" align="center">
                <template slot-scope="scope">
                    <el-button size="mini" @click="commentEdit(scope.row.id)">评价</el-button>
                </template>
            </el-table-column  >
